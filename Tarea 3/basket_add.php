...
if (isset($_POST) && !empty($_POST)) {
  ...
  $query = "INSERT INTO basquetbolistas (id, nombre, posicion, carrera, email) VALUES ($numero, '$nombre', '$posicion', '$carrera', '$email')";
            ...
            <div class="content" data-slug="panel1">
              ...
              <form method="post">
                    ...
                    <div class="col-md-12 pull-right">
                        <hr>
                            <button type="submit" class="btn btn-success">Agregar Basquetbolista</button>
                    </div>
</form>
            </div>
          </section>
